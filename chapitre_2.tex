...
\todoin{
	...
	\begin{itemize}
		\item mettre un exemple comparant AMIS et MCMC sur un cas simple (gaussienne bivariée)
		\item dans l'exemple, expliciter les formules de mise à jour des paramètres de la proposal
		\item ajouter un paragraphe de transition vers le chapitre 3
	\end{itemize}}
